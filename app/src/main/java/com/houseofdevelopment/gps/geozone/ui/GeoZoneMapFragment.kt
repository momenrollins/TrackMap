...
import com.houseofdevelopment.gps.databinding.FragmentGeoZoneMapBinding
...
class GeoZoneMapFragment : BaseFragment(), OnMapReadyCallback,
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            com.houseofdevelopment.gps.R.layout.fragment_geo_zone_map, container, false
        )
...
//        mLocationRequest.smallestDisplacement = HomeMapFragment.MIN_DISPLACEMENT
    ...
    override fun onResume() {
        ...
        handleActionBarHidePlusIcon( com.houseofdevelopment.gps.R.string.geo_zone)
        if (mGoogleApiClient.isConnected && !mRequestingLocationUpdates) {
            startLocationUpdates()
        }
    }
