 ...
 * <p>
 */
public class AnchorSheetBehaviour<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     */
    public AnchorSheetBehaviour(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    /**
     * A utility function to get the {@link AnchorSheetBehaviour} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link AnchorSheetBehaviour}.
     * @return The {@link AnchorSheetBehaviour} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> AnchorSheetBehaviour<V> from(V view) {
        ViewGroup.LayoutParams params = view.getLayoutParams();
        if (!(params instanceof CoordinatorLayout.LayoutParams)) {
            throw new IllegalArgumentException("The view is not a child of CoordinatorLayout");
        }
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params).getBehavior();
        if (!(behavior instanceof AnchorSheetBehaviour)) {
            throw new IllegalArgumentException("The view is not associated with AnchorSheetBehavior");
        }
        return (AnchorSheetBehaviour<V>) behavior;
    }
}