package com.houseofdevelopment.gps.history.ui
...
import com.houseofdevelopment.gps.databinding.FragmentVehicleHistoryNewBinding
...
import com.houseofdevelopment.gps.homemap.ui.ClusterRender
import com.houseofdevelopment.gps.homemap.ui.ClusterRenderGPS3
import com.houseofdevelopment.gps.hrmovecarmarkeranimation.AnimationClass.HRMarkerAnimation
...
import com.houseofdevelopment.gps.utils.Utils.getDates
...
import com.houseofdevelopment.gps.history.adapter.HistoryCarStatusAdapterGps3
import com.houseofdevelopment.gps.history.adapter.HistoryCarStatusAdapter
import com.houseofdevelopment.gps.history.adapter.HistoryDateTimeAdapter
import com.houseofdevelopment.gps.history.model.*
...
class VehicleHistoryNewFragment : BaseFragment(), OnMapReadyCallback,
    ...
    private fun setCarDetailData(car: Item) {
        ...
        carLat = car.tripToLat?.toDouble() ?: 0.0
        carLng = car.tripToLong?.toDouble() ?: 0.0
        ...
        Log.d(TAG, "setCarDetailData: TIME ${car.trip_m} // ${car.tripToLat} // ${car.tripToLong}")
...
//            if (isAddreadyAdded)
    ...
    private fun setHistoryList(tripDetailList: MutableList<TripDetails.FirstObj>) {
        ...
        Log.d(TAG, "Timestamp ${tripDetailList.size}")
        ...
        for (index in tempArray.indices) {
            ...
            if (nextIndex <= (tempArray.size - 1) ) {
                ...
                Log.d(
                    TAG,
                    "setHistoryList: FROM ${trip.fromList.from_t} TO ${trip.toList.to_t} ${trip.tripEventType}"
                )
                ...
                if (tempArray[index].toList.to_t < toInterval.toDouble() && toInterval - tempArray[index].toList.to_t > 300 ) {
                    ...
                    if (dateString.equals(selectedDateString) && selectedDateString.equals(
                            currentDateString,
                            true
                        )
                    ) {
                    ...
                    if (selectedDateString.equals(currentDateString, true)) {
                        ...
                        Log.e("TempArray size", "historyList[index]:" + historyList[historyList.lastIndex].toList.to_t)
    ...
    private fun initSetData() {
        ...
        val roundOff = df.format(totalDist).toDouble()
