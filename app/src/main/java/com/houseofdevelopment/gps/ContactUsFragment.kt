...
import com.houseofdevelopment.gps.databinding.FragmentContactUsBinding
...
import com.houseofdevelopment.gps.vehicallist.model.SubmitContactRequest
...
class ContactUsFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        binding.webSite.setOnClickListener {
            val myIntent =
                Intent(Intent.ACTION_VIEW, Uri.parse("http://gps.hod.sa/"))
