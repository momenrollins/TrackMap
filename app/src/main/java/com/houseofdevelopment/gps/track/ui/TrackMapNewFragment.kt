package com.houseofdevelopment.gps.track.ui
...
import com.houseofdevelopment.gps.databinding.LayoutTrackMapBinding
import com.houseofdevelopment.gps.history.model.RouteGps3
...
import com.houseofdevelopment.gps.homemap.model.CheckedUnitModel
import com.houseofdevelopment.gps.homemap.model.Item
import com.houseofdevelopment.gps.homemap.ui.CarOnMapRenderer
...
import com.houseofdevelopment.gps.track.movingcar.CarMoveAnim
    ...
    private fun createCustomMarker(
        ...
        if (!ismove) {
            ...
            Glide.with(requireContext()).asBitmap()
                ...
                .load("http://gps.hod.sa" + carDetails.uri).fitCenter()
...
//        mLocationRequest.smallestDisplacement = HomeMapFragment.MIN_DISPLACEMENT
    ...
    private fun addCarMarkerAndGetMoving(latLng: LatLng) {
        Glide.with(requireContext()).asBitmap()
            ...
            .error(R.drawable.default_car)
            .load(
                "http://gps.hod.sa" + MyPreference.getValueString(
                    PrefKey.CAR_URI, ""
                )
            ).fitCenter().into(object : CustomTarget<Bitmap?>(100, 100) {
                override fun onResourceReady(
