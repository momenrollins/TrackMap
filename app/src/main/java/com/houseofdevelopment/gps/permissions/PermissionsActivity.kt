package com.houseofdevelopment.gps.permissions
...
class PermissionsActivity : Activity() {
    ...
    private fun sendToSettings() {
        ...
        AlertDialog.Builder(this).setTitle(/*options!!.settingsDialogTitle*/applicationContext.getString(R.string.go_to_settings))
    ...
    private fun deny() {
        if (permissionHandler != null) {
            ...
            //            permissionHandler.onDeniedCallback();
        }
        finish()
    }
