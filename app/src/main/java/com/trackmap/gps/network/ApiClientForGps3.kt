package com.trackmap.gps.network

import android.util.Log
import com.google.gson.JsonIOException
import com.jakewharton.retrofit2.adapter.kotlin.coroutines.CoroutineCallAdapterFactory
import com.trackmap.gps.BuildConfig
import com.trackmap.gps.network.client.ApiInterface
...
class ApiClientForGps3 {
    companion object {
        private const val TAG = "ApiClientForGps3"
        ...
        fun getRetrofit(): Retrofit {
            ...
            val baseUrl = "https://app.tawasolmap.com"
        ...
        private fun getOkHttpClient(): OkHttpClient {
            if (okHttpClient == null) {
                try {
                    ...
                    builder.addInterceptor { chain ->
                        ...
                        val request =
                            chain.request().newBuilder()
                                .addHeader("Authorization", "aXc123sdG@qecb0")
                                .build()
                    ...
                    Log.e(TAG, "getOkHttpClient: CATCH ${e.message}")
                }
            } else {
