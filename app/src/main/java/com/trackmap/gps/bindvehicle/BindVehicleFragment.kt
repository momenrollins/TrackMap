...
import com.trackmap.gps.databinding.FragmentBindVehicleBinding
import com.trackmap.gps.homemap.model.Item
import com.trackmap.gps.network.ApiClientForBrainvire
import com.trackmap.gps.network.model.ErrorWrapper
...
class BindVehicleFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, com.trackmap.gps.R.layout.fragment_bind_vehicle, container, false)

        handleActionBar(com.trackmap.gps.R.string.bind_to_vehicle)
                    ...
                    when {
                        opt.equals("Code", true) -> {
                            if (startPoint.distanceTo(endPoint) < 500) {
                                ...
                                Toast.makeText(
                                    context!!, getString(com.trackmap.gps.R.string.you_are_far_from_the_vehicle), Toast.LENGTH_SHORT
                                ).show()
                            ...
                            val biometricPrompt = BiometricPrompt(requireActivity(), executor,
                                object : BiometricPrompt.AuthenticationCallback() {
                                    override fun onAuthenticationError(
                                        ...
                                        Toast.makeText(
                                            requireContext(), getString(com.trackmap.gps.R.string.Device_not_supported), Toast.LENGTH_SHORT
                                        ).show()
                                    }
...
//                                        model.id?.let { callApiForBindDriver("", it, "Finger") }
                            ...
                            val promptInfo = BiometricPrompt.PromptInfo.Builder()
                                .setTitle("Finger authentication for \"" + getString(com.trackmap.gps.R.string.app_name) + "\"")
                                .setSubtitle("Confirm your fingerprint to authenticate.")
                                .setNegativeButtonText(getString(com.trackmap.gps.R.string.cancel))
                                .build()
...
//                                        model.id?.let { callApiForBindDriver("", it, "Face") }
                            ...
                            val promptInfo = BiometricPrompt.PromptInfo.Builder()
                                .setTitle("Face authentication for \"" + getString(com.trackmap.gps.R.string.app_name) + "\"")
                                ...
                                val biometricPrompt = BiometricPrompt(requireActivity(), executor,
                                    object : BiometricPrompt.AuthenticationCallback() {
                                        override fun onAuthenticationError(
                                            ...
                                            Toast.makeText(
                                                requireContext(),
                                                getString(com.trackmap.gps.R.string.Device_not_supported),
                                                Toast.LENGTH_SHORT
                                            ).show()
                                        }
...
//                           findNavController().navigateUp()
                        //  findNavController().navigate(com.trackmap.gps.R.id.bindVehicleFragment)
                    } else {
