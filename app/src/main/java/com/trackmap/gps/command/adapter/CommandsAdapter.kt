package com.trackmap.gps.command.adapter
...
import com.trackmap.gps.databinding.RowItemCommdsBinding
import java.util.*

class CommandsAdapter(private val cmds: List<CommandResponseModel.CMDS>?, private val listener : CommandClickInterface) : RecyclerView.Adapter<CommandsAdapter.ViewHolder>() {
    ...
    interface CommandClickInterface {
        fun commandClick(model : CommandResponseModel.CMDS)
    }
}
